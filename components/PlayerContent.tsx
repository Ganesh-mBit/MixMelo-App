  ...
  return (
    <div className="h-full grid grid-cols-2 md:grid-cols-3">
      ...
      <div className="flex md:hidden col-auto w-full justify-end items-center">
        <div onClick={handlePlay} className="w-10 h-10 flex justify-center items-center rounded-full bg-white p-1 cursor-pointer">
      ...
      <div className="hidden h-full md:flex justify-center items-center w-full max-w-[722px] gap-x-8">
        ...
        <div onClick={handlePlay} className="w-10 h-10 flex justify-center items-center rounded-full p-1 bg-white cursor-pointer">
          <Icon size={30} className="text-black" />
        </div>
      ...
      <div className="hidden w-full md:flex justify-end pr-2">
        <div className="w-[120px] flex items-center gap-x-2">
